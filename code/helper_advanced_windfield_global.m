function [vfull,pcen,vmax]=helper_advanced_windfield_global(msize,res,cgps,ngps,penv,pcen,rmax,vmax,tint,prepcen,model)
% TC windfield calculation
% NAME:
%   isimip_windfield_holland
% PURPOSE:
%   function to determine advanced winfdield
%   --> see isimip_windfield_holland
%
...
end % helper_advanced_windfield_global
