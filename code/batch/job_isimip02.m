% batch job for cluster: bsub -R "rusage[mem=5000]" -n 24 matlab -nodisplay -singleCompThread -r job_isimip02
% MODULE:
%   isimip
% NAME:
%   job_isimip02
...
%   copy job to cluster:       scp -r Documents/_GIT/euler_jobs/job_isimip02.m dbresch@euler.ethz.ch:/cluster/home/dbresch/euler_jobs/.
%   run on cluster:            bsub -R "rusage[mem=5000]" -n 24 matlab -nodisplay -singleCompThread -r job_isimip02
...
%
% CALLING SEQUENCE:
%   bsub -R "rusage[mem=5000]" -n 24 matlab -nodisplay -singleCompThread -r job_isimip02
% EXAMPLE:
%   bsub -R "rusage[mem=5000]" -n 24 matlab -nodisplay -singleCompThread -r job_isimip02
% INPUTS:
...
track_files={
    ...
    'Trial1_GB_dkmiroc_piControlcal'
    'Trial1_GB_dkipsl_piControlcal'
    'Trial1_GB_dkgfdl_piControlcal'
    'Trial1_GB_dkmiroc_rcp26cal'
    'Trial2_GB_dkgfdl_20thcal'
    ...
    'Trial2_GB_dkmiroc_20thcal'
    'Trial1_GB_dkipsl_rcp60cal'
    'Trial1_GB_dkipsl_rcp26cal'
    'Trial2_GB_dkmiroc_rcp26cal'
    'Trial2_GB_dkipsl_rcp26cal'
    };
%
